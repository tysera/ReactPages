...
import sty from "./PlasmicButton.module.css"; // plasmic-import: DwIIKJ8MJ2B/css

import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: Z1aBbBpO1rJ/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: rg1RbQi6agz/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__neaJ)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__q4JyP)}
                role={"img"}
              />
            ),
